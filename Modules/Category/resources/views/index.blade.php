                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach ($categories as $key =>$category)
                            ...
                            <tr>
                                <th>{{ $key +=1 }}</th>
                                <td>{{ $category->name }}</td>
                                <td>{{ html_entity_decode(strip_tags($category->description)) }}</td>
                                <td>{{ $category->slug }}</td>
                                <td>
                                ...
                                <td>
                                    <label>
                                        <input id="{{ $category->id }}" onchange="changeStatus({{ $category->id }})" data-url="{{ route('admin.content.category.status', $category->id) }}" type="checkbox" @if ($category->status === '1')
                                            checked
                                            @endif>
                                    </label>
                                </td>
                                <td class="width-16-rem text-left">
                                    <a href="{{ route('admin.content.category.edit', $category->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> ویرایش</a>
