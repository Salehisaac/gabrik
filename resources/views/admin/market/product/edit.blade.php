...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page">ویرایش کالای </li>
        </ol>
    </nav>
                        ...
                        <section class="row">
                                ...
                                @foreach ($product->image['indexArray'] as $key => $value)
                                    <section class="col-md-{{ 6 / $number }} ">
                                        <div class="form-check">
                                            <input type="radio" class="form-check-inline"  name="currentImage" value="{{ $key }}" id="{{$number}}" @if($product->image['currentImage'] == $key) checked @endif>
                            ...
                            <section class="col-12 col-md-6 mt-sm-2 mt-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="published_at" id="published_at" type="text" class="form-control form-control-sm" value="{{ old('published_at', $product->published_at) }}">
                                    <input  name="" id="published_at_view" type="text" class="form-control form-control-sm" value="{{ old('published_at', $product->published_at) }}">
                                </div>
                                @error('published_at')
                                <span>
                                    <strong class="alert_required bg-danger text-white p-1  rounded" role="alert">
