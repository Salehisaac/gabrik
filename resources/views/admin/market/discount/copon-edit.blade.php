...
@section('head-tag')
    <title>ویرایش کوپون تخفیف </title>
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page">ویرایش کوپون</li>
        </ol>
    </nav>
                        ...
                        <section class="row">
                            <section class="col-12 col-md-6 mt-2">
                                <div class="form-group">
                                    ...
                                    <input name="code" value="{{old('code', $copan->code)}}" type="text" class="form-control form-control-sm ">
                                </div>
                                @error('code')
                                <span>
                            ...
                            <section class="col-12 col-md-6  mt-2">
                                <div class="form-group">
                                    ...
                                    <select id="users" name="user_id" class="form-control form-control-sm" {{ $copan->type ==0 ?  'disabled' : ''}}>
                            ...
                            <section class="col-12 col-md-6 mt-2" >
                                <div class="form-group">
                                    ...
                                    <input name="amount"  value="{{old('amount', $copan->amount)}}" type="text" class="form-control form-control-sm ">
                                </div>
                                @error('amount')
                                <span>
                                    <strong class="alert_required bg-danger text-white p-1  rounded" role="alert">
                            ...
                            <section class="col-12 col-md-6 mt-2">
                                <div class="form-group">
                                    ...
                                    <input name="discount_ceiling" value="{{old('discount_ceiling', $copan->discount_ceiling)}}" type="text" class="form-control form-control-sm ">
                                </div>
                            ...
                            <section class="col-12 col-md-6 mt-sm-2 mt-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="start_date" id="start_date" type="text" class="form-control form-control-sm" value="{{ old('start_date', $copan->start_date) }}">
                                    <input  name="" id="start_date_view" type="text" class="form-control form-control-sm" value="{{ old('start_date', $copan->start_date) }}">
                                </div>
                                @error('start_date')
                                <span>
                                    <strong class="alert_required bg-danger text-white p-1  rounded" role="alert">
                            ...
                            <section class="col-12 col-md-6 mt-sm-2 mt-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="end_date" id="end_date" type="text" class="form-control form-control-sm" value="{{ old('end_date', $copan->end_date) }}">
                                    <input  name="" id="end_date_view" type="text" class="form-control form-control-sm" value="{{ old('end_date', $copan->end_date) }}">
                                </div>
                                @error('end_date')
                                <span>
                                    <strong class="alert_required bg-danger text-white p-1  rounded" role="alert">
