...
@section('head-tag')
    <title>افزدون به فروش شگفت انگیز </title>
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page">افزدون به فروش شگفت انگیز </li>
        </ol>
    </nav>
