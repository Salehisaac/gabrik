        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    ...
                    <form action="{{ route('admin.market.discount.commonStore') }}" method="post">
                        @csrf
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6 mt-2" >
                                <div class="form-group">
                                    ...
                                    <input name="percentage" value="{{old('percentage')}}" type="text" class="form-control form-control-sm ">
                                </div>
                                @error('percentage')
                                <span>
                            ...
                            <section class="col-12 col-md-6 mt-2">
                                <div class="form-group">
                                    ...
                                    <input name="minimal_order_amount" value="{{old("minimal_order_amount")}}" type="text" class="form-control form-control-sm ">
                                </div>
