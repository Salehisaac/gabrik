...
@section('head-tag')
    <title>ویرایش مقدار فرم کالای </title>
@endsection
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page">ویرایش مقدار فرم کالای </li>
        </ol>
    </nav>
                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6 mt-2">
                                <div class="form-group">
                                    ...
                                    <input name="price_increase" value="{{old('price_increase', json_decode($value->value)->price_increase)}}" type="text" class="form-control form-control-sm ">
                                </div>
