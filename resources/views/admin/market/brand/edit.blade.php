                        ...
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="persian_name" type="text" class="form-control form-control-sm " value="{{old('persian_name' , $brand->persian_name)}}">
                                </div>
                                @error('persian_name')
                                <span>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="original_name" type="text" class="form-control form-control-sm " value="{{old('original_name',$brand->original_name)}}">
                                </div>
                            ...
                            @if (is_dir($brand->logo['directory']))
                                ...
                                @foreach ($brand->logo['indexArray'] as $key => $value)
                                    <section class="col-md-{{ 6 / $number }} ">
                                        <div class="form-check">
                                            <input type="radio" class="form-check-inline mt-3"  name="currentImage" value="{{ $key }}" id="{{$number}}" @if($brand->logo['currentImage'] == $key) checked @endif>
