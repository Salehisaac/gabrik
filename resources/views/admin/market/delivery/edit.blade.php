                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="form-control form-control-sm " value="{{ old('name', $delivery->name) }}">
                                </div>
                                @error('name')
                                <span>
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="amount" type="text" class="form-control form-control-sm " value="{{ old('amount' , $delivery->amount) }}">
                                </div>
                            ...
                            <section class="col-12 col-md-6 mt-2">
                                <div class="form-group">
                                    ...
                                    <input name="delivery_time" type="text" class="form-control form-control-sm " value="{{ old('delivery_time', $delivery->delivery_time) }}">
                                </div>
                                @error('delivery_time')
                                <span>
                                    <strong class="alert_required bg-danger text-white p-1 rounded" role="alert">
                            ...
                            <section class="col-12 col-md-6 mt-2">
                                <div class="form-group">
                                    ...
                                    <input name="delivery_time_unit" type="text" class="form-control form-control-sm" value="{{ old('delivery_time_unit', $delivery->delivery_time_unit) }}">
                                </div>
