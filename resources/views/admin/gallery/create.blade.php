...
@section('head-tag')
    <title>اضافه کردن گالری جدید </title>
@endsection
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page">اضافه کردن گالری جدید </li>
        </ol>
    </nav>
                        ...
                        @csrf
                                ...
                                <section class="col-12 col-md-6 mt-sm-2 mt-md-2">
                                    <div class="form-group">
                                        <label for="gallery[]">گالری(باید 9 عکس باشد)</label>
                                        <input name="gallery[]" id="gallery[]" type="file" class="form-control form-control-sm" multiple>
                                    </div>
