                        ...
                        @foreach($posts as $key => $post)
                            ...
                            <tr>
                                ...
                                <td class="width-16-rem" style="text-align: left">
                                    @can('update', $post)
                                    <a href="{{ route('admin.content.post.edit', $post->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit ms-1"></i>ویرایش</a>

                                    @else
                                        <a href="{{ route('admin.content.post.edit', $post->id) }}" class="btn btn-danger btn-sm disabled"><i class="fa fa-edit ms-1"></i>دسترسی ندارید</a>
