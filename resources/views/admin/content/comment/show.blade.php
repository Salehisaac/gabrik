            ...
            <section class="main-body-container">
                ...
                <section class="card mb-3 ">
                    <section class="card-header text-white bg-custom-yellow">
                        {{ $comment->user->fullName}} - {{ $comment->auther_id }}

                    </section>

                    <section class="card-body">
                        <h5 class="card-title">
                              کد کالا :   {{$comment->commentable->id}}    --------   مشخصات کالا : {{$comment->commentable->title}}  -----  دسته بندی : {{$comment->commentable->postCategory->name}}
