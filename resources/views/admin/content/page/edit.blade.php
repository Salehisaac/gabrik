...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page">ویرایش صفحه </li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    ...
                    <form action="{{ route('admin.content.page.update' , $page->id) }}" method="post" enctype="multipart/form-data" id="form">
                        @csrf
                        {{ method_field('PUT') }}
                        <section class="row">
                            <section class="col-12 col-md-6 my-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm " name="title" id="title" value="{{ old('title' , $page->title ) }}">
                                </div>
                                @error('title')
                                <span>
                            ...
                            <section class="col-12 col-md-6 mt-sm-2 mt-md-0">
                                <div class="form-group">
                            ...
                            <section class="col-12 mt-sm-2 mt-md-2">
                                <div class="form-group">
                                    <label for="description">محتوی </label>
