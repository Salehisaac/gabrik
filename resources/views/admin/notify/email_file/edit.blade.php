...
@section('head-tag')
    <title>ویرایش ضمیمه ایمیلی جدید</title>
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page">ویرایش ضمیمه ایمیلی جدید</li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    ...
                    <form action="{{ route('admin.notify.email-file.update', $file->id) }}" method="post" enctype="multipart/form-data"  id="form">
                        @csrf
                        {{ method_field('PUT') }}
                        <section class="row">
                            <section class="col-12 ">
