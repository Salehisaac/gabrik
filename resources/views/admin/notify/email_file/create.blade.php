...
@section('head-tag')
    <title>ایجاد  فایل اطلاعیه ایمیلی جدید</title>
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page">ایجاد فایل اطلاعیه ایمیلی جدید</li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="main-body-container-header">
                    ...
                    <h4>
                        ایجاد اطلاعیه فایل ایمیلی جدید
                    </h4>
                ...
                <section>
                    ...
                    <form action="{{ route('admin.notify.email-file.store', $email->id) }}" method="post" enctype="multipart/form-data" id="form">
                        @csrf
                        <section class="row">
                            <section class="col-12 ">
