...
@section('head-tag')
    <title>ویرایش اطلاعیه ایمیلی جدید</title>
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page">ویرایش اطلاعیه ایمیلی جدید</li>
        </ol>
    </nav>
                        ...
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="subject" type="text" class="form-control form-control-sm " value="{{ old('title', $email->subject) }}">
                                </div>
                            ...
                            <section class="col-12 col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="published_at" id="published_at" type="text" class="form-control form-control-sm" value="{{  $email->published_at }}">
                                    <input  name="published_at_view" id="published_at_view" type="text" class="form-control form-control-sm" value="{{  $email->published_at }}">
                                </div>
                                @error('published_at')
                                <span>
                                    <strong class="alert_required bg-danger text-white p-1  rounded" role="alert">
