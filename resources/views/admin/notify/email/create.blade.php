...
@section('head-tag')
    <title>ایجاد اطلاعیه ایمیلی جدید</title>
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page">ایجاد اطلاعیه ایمیلی جدید</li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section>
                    ...
                    <form action="{{ route('admin.notify.email.store') }}" method="post" enctype="multipart/form-data" id="form">
                        @csrf
                        <section class="row">
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="">عنوان ایمیل</label>
                                    <input name="subject" type="text" class="form-control form-control-sm " value="{{ old('subject') }}">
                                </div>
                            ...
                            <section class="col-12 col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input  name="published_at_view" id="published_at_view" type="text" class="form-control form-control-sm" value="{{ old('published_at') }}">
                                </div>
                                @error('published_at')
                                <span>
                                    <strong class="alert_required bg-danger text-white p-1  rounded" role="alert">
