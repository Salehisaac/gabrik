        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom">
                    ...
                    <a href="{{ route('admin.ticket.priority.create') }}" class="btn btn-info btn-sm ">ایجاد اولویت جدید</a>
                        ...
                        <tbody >
                            ...
                            <tr>
                                ...
                                <td class="width-16-rem" style="text-align: left">
                                    <a href="{{ route('admin.ticket.priority.edit', $ticketPriority->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit ms-1"></i>ویرایش</a>
                ...
                success : function(response){
                    if(response.status){
                        if(response.checked){
                            ...
                            successToast('اولویت تیکت شما با موفقیت فعال شد')
                        }
                        else{
                            element.prop('checked', false);
                            successToast('اولویت تیکت شما با موفقیت غیر فعال شد')
                        }
                    }
                    else{
