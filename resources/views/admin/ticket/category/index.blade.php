...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active font-size-12" aria-current="page">دسته بندی تیکت ها </li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom">
                    ...
                    <a href="{{ route('admin.ticket.category.create') }}" class="btn btn-info btn-sm ">ایجاد دسته بندی جدید</a>
                        ...
                        <tbody >
                            ...
                            <tr>
                                ...
                                <td class="width-16-rem" style="text-align: left">
                                    <a href="{{ route('admin.ticket.category.edit', $ticketCategory->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit ms-1"></i>ویرایش</a>
                ...
                success : function(response){
                    if(response.status){
                        if(response.checked){
                            ...
                            successToast('دسته بندی تیکت شما با موفقیت فعال شد')
                        }
                        else{
                            element.prop('checked', false);
                            successToast('دسته بندی تیکت شما با موفقیت غیر فعال شد')
                        }
                    }
                    else{
