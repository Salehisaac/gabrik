...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request , ImageService $imageService)
    {
        ...
        if ($request->hasFile('image'))
        {
            ...
            $imageService->setExclusiveDirectory('admin-assets/images' . DIRECTORY_SEPARATOR . 'product');
    ...
    public function update(ProductRequest $request, Product $product, ImageService $imageService)
    {
        ...
        if ($request->hasFile('image'))
        {
            ...
            if ($result === false)
            {
                return redirect()->route('admin.market.product.index')->with('swal-error', 'آپلود عکس با خطا  شد  ');
            }
        ...
        $product ->update($inputs);
            ...
            if (!empty($request->meta_key))
            {
                ...
                {
                    if ($meta['meta_key'] == null or $meta['meta_value'] ==null)
                    {
                        ProductMeta::where('id' , $meta['meta_id'])->delete();
    ...
    public function destroy(Product $product)
    {
        ...
        return redirect()->route('admin.market.product.index')->with('swal-success', 'کالا  شما با موفقیت حذف شد  ');
    }
}
