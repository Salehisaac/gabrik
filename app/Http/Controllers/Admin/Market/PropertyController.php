...
class PropertyController extends Controller
{
    ...
    public function store(CategoryAttributeRequest $request)
    {
        ...
        return redirect()->route('admin.market.property.index')->with('swal-success', 'فرم کالای  شما با موفقیت اضافه شد  ');
    }
    ...
    public function update(CategoryAttributeRequest $request, CategoryAttribute $categoryAttribute)
    {
        ...
        return redirect()->route('admin.market.property.index')->with('swal-success', 'فرم کالای  شما با موفقیت ویرایش شد  ');
    }
    ...
    public function destroy(CategoryAttribute $categoryAttribute)
    {
        ...
        return redirect()->route('admin.market.property.index')->with('swal-success', 'رنگ کالای  شما با موفقیت حذف شد  ');
    }
}
