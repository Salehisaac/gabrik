...
class CommentController extends Controller
{
    ...
    public function index()
    {
        ...
        $comments = Comment::orderBy('created_at', 'desc')->where('commentable_type' , 'App\Models\Market\Product')->paginate(10);
    ...
    public function approved(Comment $comment)
    {
        ...
        $result = $comment->save();
        return redirect()->route('admin.market.comment.index')->with('swal-success', 'وضعیت نظر  شما با موفقیت تغییر شد ');
    }
    ...
    public function answer( Comment $comment, CommentRequest $request)
    {
        ...
        {
            return redirect()->route('admin.market.comment.index')->with('swal-error', 'امکان پاسخ دهی به ادمین وجود ندارد ');
        }
