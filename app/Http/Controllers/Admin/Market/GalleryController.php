...
class GalleryController extends Controller
{
    ...
    public function store(Request $request, Product $product, ImageService $imageService)
    {
        ...
        if ($request->hasFile('image'))
        {
            ...
            $imageService->setExclusiveDirectory('admin-assets/images' . DIRECTORY_SEPARATOR . 'product/gallery');
            ...
            return redirect()->route('admin.market.gallery.index', $product->id)->with('swal-success', 'عکس جدید محصول جدید شما با موفقیت ثبت شد  ');
    ...
    public function destroy(Product $product, Gallery $gallery)
    {
        ...
        return redirect()->route('admin.market.gallery.index', $product->id)->with('swal-success', 'عکس کالای  شما با موفقیت حذف شد  ');
    }
}
