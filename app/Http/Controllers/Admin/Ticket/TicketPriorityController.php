...
class TicketPriorityController extends Controller
{
    ...
    public function store(TicketPriorityRequest $request)
    {
        ...
        return redirect()->route('admin.ticket.priority.index')->with('swal-success', 'اولویت جدید با موفقیت ایجاد شد');
    }
    ...
    public function destroy(TicketPriority $ticketPriority)
    {
        ...
        return redirect()->route('admin.ticket.priority.index')->with('swal-success', 'اولویت تیکت  شما با موفقیت حذف شد ');
    }
