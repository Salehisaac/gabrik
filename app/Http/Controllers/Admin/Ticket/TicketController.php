...
class TicketController extends Controller
{
    ...
    public function store(TicketRequest $request, Ticket $ticket)
    {
        ...
        $inputs['priority_id'] = $ticket->ticketpriority->id;
        $inputs['category_id'] = $ticket->ticketcategory->id;
        $result = Ticket::create($inputs);
        return redirect()->route('admin.ticket.index')->with('swal-success', 'پاسخ تیکت با موفقیت ایجاد شد');
    }
    ...
    public function change(Ticket $ticket)
    {
        ...
        $result = $ticket->save();
        return redirect()->route('admin.ticket.index')->with('swal-success', 'تغییرات تیکت با موفقیت ایجاد شد');
